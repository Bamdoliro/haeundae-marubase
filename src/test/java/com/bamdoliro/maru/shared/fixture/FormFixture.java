...
public class FormFixture {
    ...
    private static FormType randomFormType() {
        FormType[] values = {FormType.REGULAR, FormType.REGULAR, FormType.REGULAR, FormType.REGULAR, FormType.ONE_PARENT};
        return values[new Random().nextInt(values.length)];
    }
    ...
    public static FormResponse createFormResponse() {
        return new FormResponse(
                ...
                new GradeResponse(
                        List.of(
                                new SubjectResponse(2, 1, "국어", randomAchievementLevel(),null),
                                new SubjectResponse(2, 1, "수학", randomAchievementLevel(),null),
                                new SubjectResponse(2, 1, "사회", randomAchievementLevel(),null),
                                new SubjectResponse(2, 1, "과학", randomAchievementLevel(),null),
                                new SubjectResponse(2, 1, "영어", randomAchievementLevel(),null),
                                new SubjectResponse(2, 1, "체육", randomAchievementLevel(),null),
                                new SubjectResponse(2, 2, "국어", randomAchievementLevel(),null),
                                new SubjectResponse(2, 2, "수학", randomAchievementLevel(),null),
                                new SubjectResponse(2, 2, "사회", randomAchievementLevel(),null),
                                new SubjectResponse(2, 2, "과학", randomAchievementLevel(),null),
                                new SubjectResponse(2, 2, "영어", randomAchievementLevel(),null),
                                new SubjectResponse(2, 2, "체육", randomAchievementLevel(),null),
                                new SubjectResponse(3, 1, "국어", randomAchievementLevel(),null),
                                new SubjectResponse(3, 1, "수학", AchievementLevel.B,null),
                                new SubjectResponse(3, 1, "사회", randomAchievementLevel(),null),
                                new SubjectResponse(3, 1, "과학", randomAchievementLevel(),null),
                                new SubjectResponse(3, 1, "영어", randomAchievementLevel(),null),
                                new SubjectResponse(3, 1, "체육", randomAchievementLevel(),null)
                        ),
