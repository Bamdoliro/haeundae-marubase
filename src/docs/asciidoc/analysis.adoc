...
==== 요청
===== 전체 조회
include::{snippets}/analysis-controller-test/전체_출신_지원자들의_출신학교_통계를_조회한다/http-request.adoc[]
...
==== 응답
==== 전체 조회 정상 응답
include::{snippets}/analysis-controller-test/전체_출신_지원자들의_출신학교_통계를_조회한다/http-response.adoc[]
