...
=== 입학설명회 정보 수정
어드민은 입학 설명회의 정보를 수정할 수 있습니다.

===== Request Header
include::{snippets}/fair-controller-test/입학설명회의_정보를_수정한다/request-headers.adoc[]

===== Path Parameter
include::{snippets}/fair-controller-test/입학설명회의_정보를_수정한다/path-parameters.adoc[]

===== Request Body
include::{snippets}/fair-controller-test/입학설명회의_정보를_수정한다/request-Body.adoc[]

==== 응답

===== 정상응답
include::{snippets}/fair-controller-test/입학설명회의_정보를_수정한다/http-response.adoc[]

===== 입학설명회가 없는 경우
include::{snippets}/fair-controller-test/입학설명회의_정보를_수정할_때_입학설명회가_없다면_오류가_발생한다/http-response.adoc[]

=== 입학설명회 삭제
어드민은 입학설명회를 삭제할 수 있습니다.

===== Request Header
include::{snippets}/fair-controller-test/입학설명회를_삭제한다/request-headers.adoc[]

===== Path Parameter
include::{snippets}/fair-controller-test/입학설명회를_삭제한다/path-parameters.adoc[]

==== 응답

===== 정상응답
include::{snippets}/fair-controller-test/입학설명회를_삭제한다/http-response.adoc[]
