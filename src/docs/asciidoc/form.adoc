...
===== 중졸 검정고시 합격자 예시
include::{snippets}/form-controller-test/중졸_검정고시_합격자가_원서를_제출한다/http-request.adoc[]
...
=== 면접번호 지정
어드민은 원서의 면접번호를 지정할 수 있습니다.

==== 요청 형식

===== Request Header
include::{snippets}/form-controller-test/면접번호를_일괄_지정한다/request-headers.adoc[]

===== Request Body
include::{snippets}/form-controller-test/면접번호를_일괄_지정한다/request-fields.adoc[]

==== 요청
include::{snippets}/form-controller-test/면접번호를_일괄_지정한다/http-request.adoc[]

==== 응답

===== 정상 응답
include::{snippets}/form-controller-test/면접번호를_일괄_지정한다/http-response.adoc[]

===== 원서가 없는 경우
include::{snippets}/form-controller-test/면접번호를_지정할_때_원서가_없으면_에러가_발생한다/http-response.adoc[]