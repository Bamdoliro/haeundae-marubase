...
===== Request Header
include::{snippets}/form-controller-test/면접번호를_지정한다/request-headers.adoc[]

===== Path Parameter
include::{snippets}/form-controller-test/면접번호를_지정한다/path-parameters.adoc[]

===== Request Body
include::{snippets}/form-controller-test/면접번호를_지정한다/request-fields.adoc[]

==== 요청
include::{snippets}/form-controller-test/면접번호를_지정한다/http-request.adoc[]

==== 응답

===== 정상 응답
include::{snippets}/form-controller-test/면접번호를_지정한다/http-response.adoc[]
