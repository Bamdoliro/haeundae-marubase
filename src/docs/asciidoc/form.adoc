...
===== 원서 접수 기간이 아닌 경우
include::{snippets}/form-controller-test/원서를_제출할_때_원서_접수_기간이_아니면_에러가_발생한다/http-response.adoc[]
...
===== 원서 접수 기간이 아닌 경우
include::{snippets}/form-controller-test/원서를_최종_제출할_때_원서_접수_기간이_아니면_에러가_발생한다/http-response.adoc[]
...
=== 원서 도착 상태 변경
어드민은 원서를 도착 상태로 변경할 수 있습니다.

==== 요청 형식

===== Request Header
include::{snippets}/form-controller-test/원서를_도착으로_변경한다/request-headers.adoc[]

===== Path Parameter
include::{snippets}/form-controller-test/원서를_도착으로_변경한다/path-parameters.adoc[]

==== 요청
include::{snippets}/form-controller-test/원서를_도착으로_변경한다/http-request.adoc[]

==== 응답

===== 정상 응답
include::{snippets}/form-controller-test/원서를_도착으로_변경한다/http-response.adoc[]

===== 해당하는 원서가 없는 경우
include::{snippets}/form-controller-test/원서를_도착으로_변경할_때_원서가_없으면_에러가_발생한다/http-response.adoc[]

=== 원서 미도착 상태 변경
어드민은 원서를 미도착 상태로 변경할 수 있습니다.

==== 요청 형식

===== Request Header
include::{snippets}/form-controller-test/원서를_미도착으로_변경한다/request-headers.adoc[]

===== Path Parameter
include::{snippets}/form-controller-test/원서를_미도착으로_변경한다/path-parameters.adoc[]

==== 요청
include::{snippets}/form-controller-test/원서를_미도착으로_변경한다/http-request.adoc[]

==== 응답

===== 정상 응답
include::{snippets}/form-controller-test/원서를_미도착으로_변경한다/http-response.adoc[]

===== 해당하는 원서가 없는 경우
include::{snippets}/form-controller-test/원서를_미도착으로_변경할_때_원서가_없으면_에러가_발생한다/http-response.adoc[]
...
===== 원서 접수 기간이 아닌 경우
include::{snippets}/form-controller-test/원서를_수정할_때_원서_접수_기간이_아니면_에러가_발생한다/http-response.adoc[]
...
===== Request Body
include::{snippets}/form-controller-test/증명_사진을_업로드한다/request-fields.adoc[]
...
===== 원서 접수 기간이 아닌 경우
include::{snippets}/form-controller-test/증명_사진을_업로드할_때_원서_접수_기간이_아니면_에러가_발생한다/http-response.adoc[]

===== 미제출 또는 반려된 원서가 아닌 경우
include::{snippets}/form-controller-test/증명_사진을_업로드할_때_반려_또는_미제출_상태가_아니면_에러가_발생한다/http-response.adoc[]
...
===== Request Body
include::{snippets}/form-controller-test/원서_서류를_업로드한다/request-fields.adoc[]
...
===== 원서 접수 기간이 아닌 경우
include::{snippets}/form-controller-test/원서_서류를_업로드할_때_원서_접수_기간이_아니면_에러가_발생한다/http-response.adoc[]

===== 제출 또는 반려된 원서가 아닌 경우
include::{snippets}/form-controller-test/원서_서류를_업로드할_때_제출_또는_반려_상태가_아니면_에러가_발생한다/http-response.adoc[]
...
==== 요청 형식
===== Request Header
include::{snippets}/form-controller-test/최종합격자가_입학등록원_및_금연서약서_양식을_다운받는다/request-headers.adoc[]

==== 요청
include::{snippets}/form-controller-test/최종합격자가_입학등록원_및_금연서약서_양식을_다운받는다/http-request.adoc[]

==== 응답
===== 정상 응답
include::{snippets}/form-controller-test/최종합격자가_입학등록원_및_금연서약서_양식을_다운받는다/http-response.adoc[]

===== 원서 상태가 최종합격이 아닌 경우
include::{snippets}/form-controller-test/최종합격자가_아닌_사람이_입학등록원_및_금연서약서_양식을_다운받으면_에러가_발생한다/http-response.adoc[]
...
===== Request Body
include::{snippets}/form-controller-test/입학등록원_및_금연서약서를_업로드한다/request-fields.adoc[]
...
===== 제출 기간이 아닌 경우
include::{snippets}/form-controller-test/입학등록원_및_금연서약서를_업로드할_때_제출_기간이_아니면_에러가_발생한다/http-response.adoc[]

===== 원서 상태가 합격이 아닌 경우
include::{snippets}/form-controller-test/최종합격자가_아닌_지원자가_입학등록원_및_금연서약서를_업로드하면_에러가_발생한다/http-response.adoc[]

===== 용량이 20MB를 초과한 경우
include::{snippets}/form-controller-test/입학등록원_및_금연서약서를_업로드할_때_파일이_용량_제한을_넘으면_에러가_발생한다/http-response.adoc[]

===== pdf 파일이 아닌 경우
include::{snippets}/form-controller-test/입학등록원_및_금연서약서를_업로드할_때_콘텐츠_타입이_다르다면_에러가_발생한다/http-response.adoc[]
...
===== 입력한 점수의 타입이 잘못되거나, 범위를 초과한 경우
include::{snippets}/form-controller-test/입력한_2차_전형_점수의_타입이_잘못되거나_범위를_초과한_경우_에러가_발생한다/http-response.adoc[]
엑셀 파일 내에 잘못된 셀 표시 이후 잘못된 내용을 명시합니다.
...
===== Request Header
include::{snippets}/form-controller-test/모든_자기소개서를_pdf로_다운받는다/request-headers.adoc[]

==== 요청
include::{snippets}/form-controller-test/모든_자기소개서를_pdf로_다운받는다/http-request.adoc[]

==== 응답

===== 정상 응답
include::{snippets}/form-controller-test/모든_자기소개서를_pdf로_다운받는다/http-response.adoc[]

=== 전형료 납부
어드민은 원서의 전형료 납부 상태를 변경할 수 있습니다.

==== 요청 형식

===== Request Header
include::{snippets}/form-controller-test/전형료를_납부한다/request-headers.adoc[]

===== Path Parameter
include::{snippets}/form-controller-test/전형료를_납부한다/path-parameters.adoc[]

==== 요청
include::{snippets}/form-controller-test/전형료를_납부한다/http-request.adoc[]

==== 응답

===== 정상 응답
include::{snippets}/form-controller-test/전형료를_납부한다/http-response.adoc[]

===== 원서가 없는 경우
include::{snippets}/form-controller-test/전형료를_납부할_때_원서가_없으면_에러가_발생한다/http-response.adoc[]

=== 전형료 납부 취소
어드민은 원서의 전형료 납부를 취소할 수 있습니다.

==== 요청 형식

===== Request Header
include::{snippets}/form-controller-test/전형료_납부를_취소한다/request-headers.adoc[]

===== Path Parameter
include::{snippets}/form-controller-test/전형료_납부를_취소한다/path-parameters.adoc[]

==== 요청
include::{snippets}/form-controller-test/전형료_납부를_취소한다/http-request.adoc[]

==== 응답

===== 정상 응답
include::{snippets}/form-controller-test/전형료_납부를_취소한다/http-response.adoc[]

===== 원서가 없는 경우
include::{snippets}/form-controller-test/전형료_납부를_취소할_때_원서가_없으면_에러가_발생한다/http-response.adoc[]

=== 수험번호 수정
어드민은 원서의 수험번호를 수정할 수 있습니다.

==== 요청 형식

===== Request Header
include::{snippets}/form-controller-test/수험번호를_수정한다/request-headers.adoc[]

===== Path Parameter
include::{snippets}/form-controller-test/수험번호를_수정한다/path-parameters.adoc[]

===== Request Body
include::{snippets}/form-controller-test/수험번호를_수정한다/request-fields.adoc[]

==== 요청
include::{snippets}/form-controller-test/수험번호를_수정한다/http-request.adoc[]

==== 응답

===== 정상 응답
include::{snippets}/form-controller-test/수험번호를_수정한다/http-response.adoc[]

===== 원서가 없는 경우
include::{snippets}/form-controller-test/수험번호를_수정할_때_원서가_없으면_에러가_발생한다/http-response.adoc[]