...
=== 서류 도착 여부 일괄 변경
어드민은 여러 원서의 서류 도착 여부를 일괄로 변경할 수 있습니다.

==== 요청 형식

===== Request Header
include::{snippets}/form-controller-test/서류_도착_여부를_일괄로_변경한다/request-headers.adoc[]

===== Request Body
include::{snippets}/form-controller-test/서류_도착_여부를_일괄로_변경한다/request-fields.adoc[]

==== 요청
include::{snippets}/form-controller-test/서류_도착_여부를_일괄로_변경한다/http-request.adoc[]

==== 응답

===== 정상 응답
include::{snippets}/form-controller-test/서류_도착_여부를_일괄로_변경한다/http-response.adoc[]

===== 해당하는 원서가 없는 경우
include::{snippets}/form-controller-test/서류_도착_여부를_일괄로_변경할_때_원서가_없으면_에러가_발생한다/http-response.adoc[]
...
=== 진행료 납부 여부 일괄 변경
어드민은 여러 원서의 진행료 납부 여부를 일괄로 변경할 수 있습니다.

==== 요청 형식

===== Request Header
include::{snippets}/form-controller-test/전형료_납부_여부를_일괄로_변경한다/request-headers.adoc[]

===== Request Body
include::{snippets}/form-controller-test/전형료_납부_여부를_일괄로_변경한다/request-fields.adoc[]

==== 요청
include::{snippets}/form-controller-test/전형료_납부_여부를_일괄로_변경한다/http-request.adoc[]

==== 응답

===== 정상 응답
include::{snippets}/form-controller-test/전형료_납부_여부를_일괄로_변경한다/http-response.adoc[]
...
=======
===== 해당하는 원서가 없는 경우
include::{snippets}/form-controller-test/전형료_납부_여부를_일괄로_변경할_때_원서가_없으면_에러가_발생한다/http-response.adoc[]